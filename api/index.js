...
app.post("/api", (req, res) => {
  ...
  if (req.body.hasBBG) {
    ...
    if (totalWords >= 200) {
      res.json({ result: `Oops! Sorry bud, our conversation is longer than 200 words so sadly I can't keep talking. You can upgrade to BBG to continue talking though!` })
    } else {
